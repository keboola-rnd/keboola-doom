...
export const L2_RECORDS_BY_DIFFICULTY = [3, 7, 12];
export const L2_RECORD_SPEED    = 0.0009;
export const L2_SPAWN_INTERVALS = [8000, 4500, 3500];
export const L2_MAX_CONCURRENT  = [1, 2, 3];
// Stakeholder boss difficulty scaling [easy, medium, hard]
export const L4_BOSS_REGEN_RATE   = [20, 40, 50];
export const L4_BOSS_REQ_INTERVAL = [8000, 5500, 5000];
export const L4_BOSS_REQ_DAMAGE   = [8, 15, 18];
